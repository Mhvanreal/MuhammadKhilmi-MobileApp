...
class SkillFragment : Fragment(){
    ...
    private fun addDataToList() {
        ...
        langList.add(SkillData("Java", R.drawable.logo_java_48dp))
        langList.add(SkillData("SQl", R.drawable.sql))
        langList.add(SkillData("Corel", R.drawable.corel))
        langList.add(SkillData("PhotoShop ", R.drawable.ps))
        langList.add(SkillData("Android Studio", R.drawable.studio))
    }
